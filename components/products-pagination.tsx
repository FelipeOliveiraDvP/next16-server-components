...
export default function ProductsPagination({
  ...
  return (
    <nav
      ...
      className={`lg:sticky lg:bottom-0 z-10 mt-4 rounded-lg border border-black/10 bg-white p-3 shadow-sm ${
        className ?? ""
      }`}
    >
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          <button
            ...
            className="hidden lg:inline-flex rounded-md border border-black/15 bg-white px-3 py-2 text-sm font-medium text-black/70 shadow-sm hover:bg-black/5 disabled:cursor-not-allowed disabled:opacity-50"
